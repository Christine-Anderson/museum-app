...
CREATE TABLE NaturalSpecimen (
    ...
    FOREIGN KEY(articleID) REFERENCES Article(articleID)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    FOREIGN KEY(speciesName) REFERENCES Article(articleID)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION
);
...
CREATE TABLE Owner (
    ...
    FOREIGN KEY(postalOrZIPCode) REFERENCES PostalCode(postalOrZIPCode)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION
);
...
CREATE TABLE Displays(
    exhibitID INT,
    articleID INT,
    FOREIGN KEY(exhibitID) REFERENCES Exhibit(eID),
    FOREIGN KEY(articleID) REFERENCES Article(articleID)
);
...
VALUES
    ...
    (11112, 'William Shakespeares Comedies, Histories, & Tragedies', '2022-01-12 13:45:31', 'Good', 'Storage room 5', 'Y', 'Y', 'Y'),
    (11114, 'Tutankhamuns Mask', '2022-07-16 03:15:50', 'Good', 'on display', 'Y', 'Y', 'Y'),
    ...
    (11133, 'UBCs Main Library - now Irving K. Barber Learning Centre - under construction', '2018-08-17 14:12:32', 'Good', 'Storage room 1', 'Y', 'Y', 'Y'),
...
VALUES
    ...
    (1001, 2022-01-03, 2025-01-23, 'The University of British Columbia will loan William Shakespeares Comedies, Histories, & Tragedies to the museum from 2022-01-03 to 2025-01-23.'),
    (1002, 2022-07-02, 2025-07-02, 'The Egyptian Museum will loan Tutankhamuns Mask and Papyrus of Ani - Book of the Dead to the museum from 2022-07-02 to 2025-07-02.'),
