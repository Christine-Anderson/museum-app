...
INSERT ALL
    ...
    INTO article(article_id, article_name, date_aquired, article_condition, storage_location, uv_protection, temp_control, humidity_control)
    VALUES (11118, 'Jade Death Mask of K''inich Janaab'' Pakal', TO_TIMESTAMP('2017-03-25 14:40:49', 'YYYY-MM-DD HH24:MI:SS'), 'Excellent', 'on display', 'Y', 'Y', 'Y')
    INTO article(article_id, article_name, date_aquired, article_condition, storage_location, uv_protection, temp_control, humidity_control)
...
INSERT ALL
    ...
    INTO collection (collection_id, name, sin) VALUES (4, 'Historical Literature', 222222222)
    INTO collection (collection_id, name, sin) VALUES (5, 'Sculpture and Statue', 333333333)
SELECT 1 FROM DUAL;

INSERT ALL
    INTO contains (article_id, collection_id) VALUES (11114, 1)
    INTO contains (article_id, collection_id) VALUES (11118, 1)
    INTO contains (article_id, collection_id) VALUES (11119, 1)
    INTO contains (article_id, collection_id) VALUES (11120, 1)
    INTO contains (article_id, collection_id) VALUES (11121, 1)
    INTO contains (article_id, collection_id) VALUES (11115, 2)
    INTO contains (article_id, collection_id) VALUES (11116, 2)
    INTO contains (article_id, collection_id) VALUES (11122, 2)
    INTO contains (article_id, collection_id) VALUES (11123, 2)
    INTO contains (article_id, collection_id) VALUES (11124, 2)
    INTO contains (article_id, collection_id) VALUES (11111, 3)
    INTO contains (article_id, collection_id) VALUES (11125, 3)
    INTO contains (article_id, collection_id) VALUES (11126, 3)
    INTO contains (article_id, collection_id) VALUES (11127, 3)
    INTO contains (article_id, collection_id) VALUES (11112, 4)
    INTO contains (article_id, collection_id) VALUES (11135, 4)
    INTO contains (article_id, collection_id) VALUES (11136, 4)
    INTO contains (article_id, collection_id) VALUES (11137, 4)
    INTO contains (article_id, collection_id) VALUES (11128, 5)
SELECT 1 FROM DUAL;
